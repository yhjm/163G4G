...
<body class="frame-bd">
	<ul class="left-menu">
		...
		<c:if test="${user.type ==0 }">
			<li>
			<a href="commonServlet?cmd=getcountProvider" target="mainFrame"> 
			<img src="images/btn_suppliers.gif" />
			</a>
			</li>
			<li>
			<a href="commonServlet?cmd=getCountUser" target="mainFrame"> 
			...
			<li>
				<a href="user?cmd=exit"> <img src="images/btn_exit.gif" />
				</a>
			</li>
	</ul>
</body>
